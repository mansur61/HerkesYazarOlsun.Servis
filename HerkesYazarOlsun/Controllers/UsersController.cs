    ...
    public class UsersController : BaseApiController
    {
        ...
        public ServiceResult PostKisiUpdate(VM_USERS kisi)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    result.Message = "Bu şekilde mail adresi yok";
                    return result;
                }
        ...
        public ServiceResult PostKisiSave(VM_USERS kisi)
        {
            ...
            try
            {
                ...
                {
                    result.State = MessageResultState.WARNING;
                    result.Message = "Böyle bir kullanıcı var.";
                    return result;
                }
                else
                {
                    user = userService.Ekle(user, kisi.EMAIL ?? "");
                    result.Message = "Kayıt Alındı";
                }
        ...
        public ServiceResult<Users> GetKisiByMail(string mail)
        {
            ...
            else
            {
                ...
                result.Message = "Mail adresi yok,kayıt yaptırınız.";
                result.State = MessageResultState.ERROR;
        ...
        public List<VM_USERS> GetKisiler(VM_ARAMA_INPUT arama)
        {
            ...
            // Yazar adı araması (null ve case-insensitive güvenli)
            ...
            // Sadece favori yazarları filtrele
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        result.Message = "Takipten Çıkıldı.";
                    }
